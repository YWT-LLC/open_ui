  ...
  void _buildThemeData() {
    ...
    if (_isDark) {
      ...
      _design = EzDesignCache(
        ...
        backgroundImageFit: boxFitLib[EzConfig.get(darkBackgroundImageKey + boxFitSuffix)],
      ...
      _design = EzDesignCache(
        ...
        backgroundImageFit: boxFitLib[EzConfig.get(lightBackgroundImageKey + boxFitSuffix)],
