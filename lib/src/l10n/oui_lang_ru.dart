...
class OUILangRu extends OUILang {
  OUILangRu([String locale = 'ru']) : super(locale);
  ...
  @override
  String get gOpenYWT => 'Открыть ссылку на YWT LLC';

  @override
  String get gOpenUISourceHint => 'Открыть страницу GitHub для Open UI';
