...
class OUILangZh extends OUILang {
  OUILangZh([String locale = 'zh']) : super(locale);
  ...
  @override
  String get gOpenYWT => '打开 YWT LLC 的链接';

  @override
  String get gOpenUISourceHint => '打开 Open UI 的 GitHub 页面';
...
class OUILangZhCn extends OUILangZh {
  OUILangZhCn() : super('zh_CN');
