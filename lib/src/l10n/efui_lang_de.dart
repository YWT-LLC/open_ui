...
class EFUILangDe extends EFUILang {
  EFUILangDe([String locale = 'de']) : super(locale);
  ...
  @override
  String get gOpenEmpathetech => 'Link zu Empathetic LLC öffnen';

  @override
  String get gEFUISourceHint => 'GitHub-Seite für EFUI öffnen';
