...
class EFUILangKo extends EFUILang {
  EFUILangKo([String locale = 'ko']) : super(locale);
  ...
  @override
  String get gLoadingAnim => '로딩 중. Empathetic 로고가 회전하는 모래시계처럼 애니메이션 처리됩니다.';
  ...
  @override
  String get gOpenEmpathetech => 'Empathetic LLC 링크 열기';

  @override
  String get gEFUISourceHint => 'EFUI용 GitHub 페이지 열기';
