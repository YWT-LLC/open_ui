...
class OUILangSw extends OUILang {
  OUILangSw([String locale = 'sw']) : super(locale);
  ...
  @override
  String get gOpenYWT => 'Fungua kiungo cha YWT LLC';

  @override
  String get gOpenUISourceHint => 'Fungua ukurasa wa GitHub wa Open UI';
