...
class OUILangUk extends OUILang {
  OUILangUk([String locale = 'uk']) : super(locale);
  ...
  @override
  String get gOpenYWT => 'Відкрити посилання на YWT LLC';

  @override
  String get gOpenUISourceHint => 'Відкрити сторінку GitHub для Open UI';
