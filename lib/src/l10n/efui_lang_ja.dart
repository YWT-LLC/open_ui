...
class EFUILangJa extends EFUILang {
  EFUILangJa([String locale = 'ja']) : super(locale);
  ...
  @override
  String get gLoadingAnim => '読み込み中。Empatheticのロゴが砂時計のように回転しています。';
  ...
  @override
  String get gOpenEmpathetech => 'Empathetic LLCへのリンクを開く';

  @override
  String get gEFUISourceHint => 'EFUIのGitHubページを開く';
