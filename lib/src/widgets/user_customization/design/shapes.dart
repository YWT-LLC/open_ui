...
class ParallelogramBorder extends OutlinedBorder {
  ...
  const ParallelogramBorder({super.side, required this.lefty, this.slope = gramSlope});
  ...
  ShapeBorder scale(double t) =>
      ParallelogramBorder(side: side.scale(t), lefty: lefty, slope: slope * t);
}
...
class GemBorder extends OutlinedBorder {
  ...
  const GemBorder({super.side, this.pointWidth = jewelSlope});

  @override
  OutlinedBorder copyWith({BorderSide? side, double? pointWidth}) =>
      GemBorder(side: side ?? this.side, pointWidth: pointWidth ?? this.pointWidth);
  ...
  @override
  ShapeBorder scale(double t) => GemBorder(side: side.scale(t), pointWidth: pointWidth * t);
}
