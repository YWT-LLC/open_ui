# global
## Keywords
Accessibility, UI, User Interface, UX, User Experience, Design, User Customization, Open Source



# ar
## Promotional text
صُمم من أجلك، وبواسطتك

## Description
اكتشف Open UI، مُنشئ التطبيقات الوحيد الذي يوفر سهولة وصول حقيقية.

يُعد Open UI بيئة تجريبية (Sandbox) حيث يمكنك التحكم في كل جانب من جوانب مظهر التطبيق.

هل تريد خطوطاً مرحة، وألواناً نابضة بالحياة، وصورة لحيوانك الأليف على كل شاشة؟ لا مشكلة.

هل تحتاج إلى تصميمات عالية التباين، ونقاط لمس كبيرة، ودعم لقارئ الشاشة؟ نحن نوفر لك كل ذلك.

بعد ذلك، عندما تصبح واجهة المستخدم بالشكل الذي يعجبك تماماً: انقر على "إنشاء" (Generate) واجعل حلم هذا (التطبيق) حقيقة.
...
Möchtest du lustige Schriftarten, lebendige Farben und ein Bild deines Haustieres auf jedem Bildschirm? Kein Problem.
...
Open UI is a sandbox where every aspect of the app’s appearance can be controlled by you.

Do you want fun fonts, vibrant colors, and a picture of your pet on every screen? No problem.
...
Open UI es un entorno de pruebas donde tú puedes controlar cada aspecto de la apariencia de la aplicación.

¿Quieres fuentes divertidas, colores vibrantes y una foto de tu mascota en cada pantalla? No hay problema.
...
Ang Open UI ay isang sandbox kung saan makokontrol mo ang bawat aspeto ng hitsura ng app.

Gusto mo ba ng mga nakakatuwang font, matingkad na kulay, at larawan ng iyong alagang hayop sa bawat screen? Walang problema.
...
Open UI est un bac à sable où vous pouvez contrôler chaque aspect de l'apparence de l'application.

Vous voulez des polices amusantes, des couleurs éclatantes et une photo de votre animal de compagnie sur chaque écran ? Pas de problème.
...
Open UI एक सैंडबॉक्स है जहां ऐप की दिखावट के हर पहलू को आप स्वयं नियंत्रित कर सकते हैं।

क्या आपको मज़ेदार फ़ॉन्ट्स, जीवंत रंग और हर स्क्रीन पर अपने पालतू जानवर की तस्वीर चाहिए? कोई बात नहीं।
...
Open UI se yon espas tès kote se ou menm ki ka kontwole chak aspè nan aparans aplikasyon an.

Ou vle polis amizan, koulè vivan, ak yon foto bèt kay ou sou chak ekran? Pa gen pwoblèm.
...
Open UIは、アプリの外観のあらゆる要素をあなた自身でコントロールできるサンドボックスです。

楽しいフォントや鮮やかなカラーを使って、すべての画面にペットの写真を配置したいですか？ 問題ありません。
...
Open UI는 앱 디자인의 모든 요소를 사용자가 직접 제어할 수 있는 샌드박스입니다.

재미있는 폰트, 생동감 넘치는 색상, 그리고 모든 화면에 반려동물의 사진을 넣고 싶으신가요? 문제없습니다.
...
Open UI — это песочница, в которой вы можете управлять каждым аспектом внешнего вида приложения.

Хотите забавные шрифты, яркие цвета и фотографию вашего питомца на каждом экране? Без проблем.
...
Open UI ni sehemu ya majaribio ambapo kila kipengele cha mwonekano wa programu kinaweza kudhibitiwa na wewe.

Je, unataka fonti za kufurahisha, rangi angavu, na picha ya mnyama wako kipenzi kwenye kila skrini? Hakuna shida.
...
Open UI — це пісочниця, де ви можете контролювати кожен аспект зовнішнього вигляду застосунку.

Бажаєте веселі шрифти, яскраві кольори та фото вашого улюбленця на кожному екрані? Без проблем.
...
Open UI 是一个沙盒，您可以在其中控制应用外观的方方面面。

想要有趣的字体、鲜艳的色彩，并在每个屏幕上都放上您的宠物照片吗？没问题。
